...
namespace Final
{
    public partial class MainPage : ContentPage
    {
        ...
        //Azure FaceServiceInstance
        private const string APIKEY = "75eee798526942e0af6d994a45f37f9f";
        private const string ENDPOINT = "https://algonquininstance.cognitiveservices.azure.com/";
        //Azure FaceServiceInstance
        private const string FACEAPIKEY = "67bb8746590247f8924147ca1b89167c";
        private const string FACEENDPOINT = "https://faceserviceinstance.cognitiveservices.azure.com/";
        ...
        private void mainCanvasControl_PaintSurface(object sender, SkiaSharp.Views.Forms.SKPaintSurfaceEventArgs e)
        {
            ...
            if(faceRectangles.Length > 0)
            {
                foreach(var faceRect in faceRectangles)
                {
                    ...
                    //canvas.DrawRect((faceRect.Left), (faceRect.Top), (faceRect.Width), (faceRect.Height), redStrokePaint);
                }
            };
        }
